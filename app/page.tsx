  ...
  return (
    <main className="min-h-screen mt-12">
      <section className="chatbot-landing-header mb-12">
        ...
        <p className="mt-4">
          We&apos;re your go-to online shopping hub, offering a handpicked
          selection of products that cater to your lifestyle. From fashion and
          electronics to home decor and more, we bring you the latest trends and
          essentials. Explore our virtual aisles, find what you need, and enjoy
      ...
      <section className="mb-12">
        ...
        {loading ? (
          ...
          <div className="flex justify-center w-full gap-4 mt-8">
            {/* <hr className='chatbot-divider flex-1' /> */}
            <button
              className="chatbot-button flex rounded-md items-center justify-center px-2.5"
              onClick={getProducts}
            >
